...
public class OpenSearchMultiValueExpand extends SingleRel implements OpenSearchRelNode, DistributionAware {
    ...
    public OpenSearchMultiValueExpand(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, int fieldIndex, List<String> viableBackends) {
    ...
    public RelWriter explainTerms(RelWriter pw) {
        return super.explainTerms(pw)
            .item("field", getInput().getRowType().getFieldNames().get(fieldIndex))
